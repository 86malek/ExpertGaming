			...
			<?php
				...
				$img_config_banniere = $PDO_query_img_config_banniere->fetch();
					...
					echo '
						...
						<div class="item">
							<a href="#"><img src="https://betatest.expert-gaming.tn' . $img_config_banniere['eg_image_config_nom'] . '" alt="' . $img_config_banniere['eg_image_config_title'] . '" class="img-responsive"></a>

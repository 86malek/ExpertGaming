			...
			<div id="content" class="col-md-12 col-sm-8">
				<div class="article-info">
					...
					<div class="form-group">
						<a href="image/demo/blog/blog4.jpg" class="image-popup"><img src="<?php if(!empty($id_comm)){echo $communication['eg_comm_img'];}?>" alt="<?php if(!empty($id_comm)){echo $communication['eg_comm_titre'];}?>"></a>
					</div>
					<hr>

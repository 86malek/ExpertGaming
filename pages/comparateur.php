	...
	<div id="wrapper" class="wrapper-full">
		...
		<div class="main-container container">
			...
			<div class="row">
				...
				<h2 class="title">Comparateur</h2>
					<div class="table-responsive">
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
								<td colspan="4"><strong>Détails du produit</strong></td>
								</tr>
							</thead>
							<tbody>
								<tr>
							...
							<tbody>
								...
								<tr>
								<td></td>
								<td><input type="button" onclick="" class="btn btn-primary btn-block" value="Ajouter au panier">
									<a class="btn btn-danger btn-block" href="#">Supprimer</a></td>
								<td><input type="button" onclick="" class="btn btn-primary btn-block" value="Ajouter au panier">
									<a class="btn btn-danger btn-block" href="#">Supprimer</a></td>
								<td><input type="button" onclick="" class="btn btn-primary btn-block" value="Ajouter au panier">
									<a class="btn btn-danger btn-block" href="#">Supprimer</a></td>

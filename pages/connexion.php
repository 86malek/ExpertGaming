					...
					<div class="account-border">
						<div class="row">
							<div class="col-sm-6 new-customer">
								<div class="well">
									<h2><i class="fa fa-file-o" aria-hidden="true"></i>Nouveau Client</h2>
									<p>En créant un compte, vous pourrez faire vos achats plus rapidement, être au courant de l'état d'une commande et suivre les commandes que vous avez déjà passées.</p>
								</div>
								<div class="bottom-form">
									<a href="http://<?php echo $_SERVER['SERVER_NAME']?>/ExpertGaming/Inscription" class="btn btn-default pull-right">S'inscrire</a>
								</div>
							</div>
							...
							<form action="#" method="post" enctype="multipart/form-data">
								<div class="col-sm-6 customer-login">
									<div class="well">
										<h2><i class="fa fa-file-text-o" aria-hidden="true"></i>Déjà Client</h2>
									...
									<div class="bottom-form">
										...
										<input type="submit" value="Se connecter" class="btn btn-default pull-right" />
									</div>
								</div>
							</form>
						</div>

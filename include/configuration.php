												...
												<div class="banner htmlconten1 col-lg-4 col-md-12 col-sm-12 col-xs-12">
													<div class="banners">
														<div>
															...
															<div class="item">
																<a href="#"><img src="admin/upload_images/' . $img_config_top['eg_image_config_nom'] . '" alt="' . $img_config_top['eg_image_config_title'] . '" class="img-responsive"></a>
															</div>
									...
									<div class="banner htmlconten1 col-lg-4 col-md-12 col-sm-12 col-xs-12">
										<div class="banners">
											<div>
												...
												<div class="item">
													<a href="#"><img src="admin/upload_images/' . $img_config_bottom['eg_image_config_nom'] . '" alt="' . $img_config_bottom['eg_image_config_title'] . '" class="img-responsive"></a>
												</div>

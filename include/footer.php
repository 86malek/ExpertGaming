								...
								<div class="block-policy-top ">
									<div class="policy policy1 col-sm-4 col-xs-12">
										<div class="policy-inner">
											...
											<h4>Ouvert 6j/7</h4>
											<span>De 9h à 13h et de 14h30 à 19h</span>
										</div>
									</div>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-3 box-information">
						<div class="module clearfix">
							...
							<div class="modcontent">
								<ul class="menu">
									<li><a href="http://<?php echo $_SERVER['SERVER_NAME']?>/ExpertGaming/A_propos_de_nous">À propos de nous</a></li>
									<li><a href="http://<?php echo $_SERVER['SERVER_NAME']?>/ExpertGaming/Faq">FAQ</a></li>
									<li><a href="http://<?php echo $_SERVER['SERVER_NAME']?>/ExpertGaming/Historique_des_commandes">Historique des commandes</a></li>
									<li><a href="http://<?php echo $_SERVER['SERVER_NAME']?>/ExpertGaming/Suivi_commande">Informations sur la commande</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6 col-md-3 collapsed-block ">
						<div class="module clearfix">
							<h3 class="modtitle">NOS COORDONNÉES
							</h3>
							<div class="modcontent">
								<ul class="contact-address">
									<li><span class="fas fa-map-pin"></span> Menzah 6, galerie le Colisée 8<sup>éme</sup> boutique à droite, En face de la Clinique Farabi</li>
